...
std::unique_ptr<std::unordered_map<uint8_t, std::unique_ptr<OpCode>>> OpCodeSingleton::opcode_map = nullptr;
std::unique_ptr<std::vector<std::unique_ptr<OpCode>>> OpCodeSingleton::opcodes = nullptr;

void OpCodeSingleton::init_opcodes()
{
    opcodes = std::make_unique<std::vector<std::unique_ptr<OpCode>>>();
    ...
    opcodes->emplace_back(std::make_unique<OpCode>(0x7d, "ADC", 3, 4 /*+1 if page crossed*/, AddressingMode::Absolute_X));
    opcodes->emplace_back(std::make_unique<OpCode>(0x79, "ADC", 3, 4 /*+1 if page crossed*/, AddressingMode::Absolute_Y));
    opcodes->emplace_back(std::make_unique<OpCode>(0x61, "ADC", 2, 6, AddressingMode::Indirect_X));
    opcodes->emplace_back(std::make_unique<OpCode>(0x71, "ADC", 2, 5 /*+1 if page crossed*/, AddressingMode::Indirect_Y));
    ...
    opcodes->emplace_back(std::make_unique<OpCode>(0xfd, "SBC", 3, 4 /*+1 if page crossed*/, AddressingMode::Absolute_X));
    opcodes->emplace_back(std::make_unique<OpCode>(0xf9, "SBC", 3, 4 /*+1 if page crossed*/, AddressingMode::Absolute_Y));
    opcodes->emplace_back(std::make_unique<OpCode>(0xe1, "SBC", 2, 6, AddressingMode::Indirect_X));
    opcodes->emplace_back(std::make_unique<OpCode>(0xf1, "SBC", 2, 5 /*+1 if page crossed*/, AddressingMode::Indirect_Y));
    ...
    opcodes->emplace_back(std::make_unique<OpCode>(0x3d, "AND", 3, 4 /*+1 if page crossed*/, AddressingMode::Absolute_X));
    opcodes->emplace_back(std::make_unique<OpCode>(0x39, "AND", 3, 4 /*+1 if page crossed*/, AddressingMode::Absolute_Y));
    opcodes->emplace_back(std::make_unique<OpCode>(0x21, "AND", 2, 6, AddressingMode::Indirect_X));
    opcodes->emplace_back(std::make_unique<OpCode>(0x31, "AND", 2, 5 /*+1 if page crossed*/, AddressingMode::Indirect_Y));
    ...
    opcodes->emplace_back(std::make_unique<OpCode>(0x5d, "EOR", 3, 4 /*+1 if page crossed*/, AddressingMode::Absolute_X));
    opcodes->emplace_back(std::make_unique<OpCode>(0x59, "EOR", 3, 4 /*+1 if page crossed*/, AddressingMode::Absolute_Y));
    opcodes->emplace_back(std::make_unique<OpCode>(0x41, "EOR", 2, 6, AddressingMode::Indirect_X));
    opcodes->emplace_back(std::make_unique<OpCode>(0x51, "EOR", 2, 5 /*+1 if page crossed*/, AddressingMode::Indirect_Y));
    ...
    opcodes->emplace_back(std::make_unique<OpCode>(0x1d, "ORA", 3, 4 /*+1 if page crossed*/, AddressingMode::Absolute_X));
    opcodes->emplace_back(std::make_unique<OpCode>(0x19, "ORA", 3, 4 /*+1 if page crossed*/, AddressingMode::Absolute_Y));
    opcodes->emplace_back(std::make_unique<OpCode>(0x01, "ORA", 2, 6, AddressingMode::Indirect_X));
    opcodes->emplace_back(std::make_unique<OpCode>(0x11, "ORA", 2, 5 /*+1 if page crossed*/, AddressingMode::Indirect_Y));
    ...
    opcodes->emplace_back(std::make_unique<OpCode>(0xdd, "CMP", 3, 4 /*+1 if page crossed*/, AddressingMode::Absolute_X));
    opcodes->emplace_back(std::make_unique<OpCode>(0xd9, "CMP", 3, 4 /*+1 if page crossed*/, AddressingMode::Absolute_Y));
    opcodes->emplace_back(std::make_unique<OpCode>(0xc1, "CMP", 2, 6, AddressingMode::Indirect_X));
    opcodes->emplace_back(std::make_unique<OpCode>(0xd1, "CMP", 2, 5 /*+1 if page crossed*/, AddressingMode::Indirect_Y));
    ...
    opcodes->emplace_back(
        std::make_unique<OpCode>(0xd0, "BNE", 2, 2 /*(+1 if branch succeeds +2 if to a new page)*/, AddressingMode::NoneAddressing));
    opcodes->emplace_back(
        std::make_unique<OpCode>(0x70, "BVS", 2, 2 /*(+1 if branch succeeds +2 if to a new page)*/, AddressingMode::NoneAddressing));
    opcodes->emplace_back(
        std::make_unique<OpCode>(0x50, "BVC", 2, 2 /*(+1 if branch succeeds +2 if to a new page)*/, AddressingMode::NoneAddressing));
    opcodes->emplace_back(
        std::make_unique<OpCode>(0x30, "BMI", 2, 2 /*(+1 if branch succeeds +2 if to a new page)*/, AddressingMode::NoneAddressing));
    opcodes->emplace_back(
        std::make_unique<OpCode>(0xf0, "BEQ", 2, 2 /*(+1 if branch succeeds +2 if to a new page)*/, AddressingMode::NoneAddressing));
    opcodes->emplace_back(
        std::make_unique<OpCode>(0xb0, "BCS", 2, 2 /*(+1 if branch succeeds +2 if to a new page)*/, AddressingMode::NoneAddressing));
    opcodes->emplace_back(
        std::make_unique<OpCode>(0x90, "BCC", 2, 2 /*(+1 if branch succeeds +2 if to a new page)*/, AddressingMode::NoneAddressing));
    opcodes->emplace_back(
        std::make_unique<OpCode>(0x10, "BPL", 2, 2 /*(+1 if branch succeeds +2 if to a new page)*/, AddressingMode::NoneAddressing));
    ...
    opcodes->emplace_back(std::make_unique<OpCode>(0xbd, "LDA", 3, 4 /*+1 if page crossed*/, AddressingMode::Absolute_X));
    opcodes->emplace_back(std::make_unique<OpCode>(0xb9, "LDA", 3, 4 /*+1 if page crossed*/, AddressingMode::Absolute_Y));
    opcodes->emplace_back(std::make_unique<OpCode>(0xa1, "LDA", 2, 6, AddressingMode::Indirect_X));
    opcodes->emplace_back(std::make_unique<OpCode>(0xb1, "LDA", 2, 5 /*+1 if page crossed*/, AddressingMode::Indirect_Y));
    ...
    opcodes->emplace_back(std::make_unique<OpCode>(0xbe, "LDX", 3, 4 /*+1 if page crossed*/, AddressingMode::Absolute_Y));
    ...
    opcodes->emplace_back(std::make_unique<OpCode>(0xbc, "LDY", 3, 4 /*+1 if page crossed*/, AddressingMode::Absolute_X));
...
{
    opcode_map = std::make_unique<std::unordered_map<uint8_t, std::unique_ptr<OpCode>>>();
